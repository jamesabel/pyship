...
from pyship import create_lip, AppInfo, PyshipLog, get_logger, __author__

from test_pyship import TstAppDirs, TST_APP_NAME, __application_name__, PYSHIP_DIST_DIR
...
def test_create_lip():
    ...
    lip_dir = create_lip(app_info, tst_app_dirs.app_dir, True, tst_app_dirs.dist_dir, tst_app_dirs.cache, [PYSHIP_DIST_DIR])
    log.info(f"{lip_dir=}")
